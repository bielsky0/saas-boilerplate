    ...
    <form method="GET" action="/admin/users" className="flex flex-wrap items-end gap-3">
      ...
      <div>
        ...
        <select
          ...
          className="border-input bg-background ring-offset-background focus-visible:ring-ring mt-1.5 h-9 rounded-md border px-3 py-1 text-sm focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-offset-2"
        >
