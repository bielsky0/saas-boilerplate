 ...
 * the provider reports it. Divide here, at the one place that renders it for a
 * human — never upstream, where a float would then be summed.
 *
 * The locale is an argument (§16.1): the amount cannot disagree with the words
 * around it.
 */
