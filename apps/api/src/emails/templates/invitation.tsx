...
export function Invitation(
  ...
  return (
    <EmailLayout preview={t("invitation.preview", { inviterName, orgName })}>
      ...
      <Text>
        {/*
          `t.rich`, not `t`: the emphasis is part of the sentence, so it belongs
          in the message where a translator can move it. Polish word order
          differs from English, and a template that hard-codes <strong> around
          the second interpolation would bold the wrong word in half the
          languages.
        */}
